...
# 🧬 System Architecture: The ReactPortal Monolith
...
## 1. 🏗️ High-Level Architecture Strategy
...
## 2. 🛡️ Data Physics & "The Laws of the DB"
...
*   **The Solution:** Use **Partial Unique Indexes**.
    *   ❌ **Bad:** `CONSTRAINT uq_code UNIQUE (code)`
    *   ✅ **Good:** `CREATE UNIQUE INDEX idx_code_active ON table(code) WHERE is_deleted = FALSE;`
...
## 3. 🗺️ Entity-Relationship Logic (The Super-Schema)

### 🧩 Module A: Identity (Global Scope)
...
### 🏢 Module B: Tenancy & Catalog (Dedicated Instances)
...
### 🌐 Module C: Portal Gateway (Routing)
...
### 👥 Module D: Resource Allocation (Staffing)
*The Staffing Matrix.*
...
## 4. 📝 Enumeration Constants (The 6 Roles)
...
## 5. 🛠️ Migration Strategy (From Legacy)
...
## ❓ Architectural Clarifications (Q&A for AI)
