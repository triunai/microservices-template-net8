...
// TODO: PLEASE migrate to isActive boolean column, currently clients dont have it 
...
if (!string.IsNullOrWhiteSpace(tenantCode))
{
    ...
    // Note: Currently uses status field. ADD adding isActive boolean column for easier querying.
    if (client.Status != "Active") // TODO: PLEASE migrate to isActive boolean column
    {
        _logger.LogWarning(
