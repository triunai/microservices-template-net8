...
namespace MicroservicesBase.Infrastructure.Resilience;
...
public static class ResiliencePolicies
{
    ...
    /// Based on SQL Server error codes for timeouts, deadlocks, and connection issues.
    /// </summary>
    public static bool IsSqlTransientError(Exception exception)
    {
        return exception switch
        {
            ...
            {
                SqlConstants.ErrorCodes.Timeout => true,            // -2: Timeout expired
                SqlConstants.ErrorCodes.ConnectionBroken => true,   // -1: Connection-level error
                SqlConstants.ErrorCodes.Deadlock => true,           // 1205: Deadlock victim
                SqlConstants.ErrorCodes.LockTimeout => true,        // 1222: Lock timeout
                SqlConstants.ErrorCodes.TransportError => true,     // 64: Transport error
                // Azure SQL specific (if needed later):
                ...
                _ => false     // Don't retry constraint violations, syntax errors, etc.
            },
